...
public protocol _Subject: AnyObject, _Publisher {
  ...
  func send(completion: _Subscribers.Completion<Self.Failure>)
  ...
  func send(subscription: _Subscription)
}
extension _Subject where Self.Output == Void {
  /// Signals subscribers.
  public func send() {
    send(())
  }
