...
public protocol _Scheduler {
  ...
  associatedtype SchedulerTimeType: Strideable where Self.SchedulerTimeType.Stride: _SchedulerTimeIntervalConvertible
  ...
  func schedule(after date: Self.SchedulerTimeType, interval: Self.SchedulerTimeType.Stride, tolerance: Self.SchedulerTimeType.Stride, options: Self.SchedulerOptions?, _ action: @escaping () -> Void) -> _Cancellable
}
extension _Scheduler {
  ...
  public func schedule(after date: Self.SchedulerTimeType, interval: Self.SchedulerTimeType.Stride, tolerance: Self.SchedulerTimeType.Stride, _ action: @escaping () -> Void) -> _Cancellable {
  ...
  public func schedule(after date: Self.SchedulerTimeType, interval: Self.SchedulerTimeType.Stride, _ action: @escaping () -> Void) -> _Cancellable {
    return schedule(after: date, interval: interval, tolerance: minimumTolerance, options: nil, action)
  }
}
